...
public class DriverTable extends JFrame {
	...
	String[][]data;
	String colnames[]={"Driverid","Name","Address","Contact"};
...
/*	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DriverTable frame = new DriverTable();
	...
	String strcount="select count(*) from driverdetail";
...
String strdata="select * from driverdetail";
